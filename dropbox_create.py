...
def createDropbox(br, fname, lname, email, password):
	br.open("https://www.dropbox.com/login")
	br.select_form(nr=2)
	br.form.set_value("varun", "fname")
	br.form.set_value("berry", "lname")
	br.form.set_value("uiuclotsbox.@gmail.com", name="email")
	br.form.set_value("berry123", "password")
	br.form.find_control("tos_agree").items[0].selected=True
	br.submit()

def createApp(br, appname, fileTypes=[0, 1, 2])
